...
<body>
	<div id="page">
		<div id="tool-bar">
		  <div class="container">
		  <div class="tool"><a href="frontend/member/member_apply.php">加入會員</a> 。 <a href="frontend/member/member_login.php">會員登入</a> 。 <a href="frontend/member/my_cart.php"><i class="fa fa-shopping-cart fa-lg" aria-hidden="true"></i></a>
		  </div>
		</div>
		</div>
		<div id="header">
		  <div class="container">
		    ...
		    <ul id="navigation">
		      ...
		      <li class="menu">
		        <a href="frontend/news.php">最新消息</a>
		      </li>
		      <li>
