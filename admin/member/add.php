          ...
          <div class="col-md-12">
            <form class="form-horizontal" role="form" data-toggle="validator">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="file" class="form-control" id="Title" data-error="請輸入字元" required>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="Title" data-error="請輸入字元" required>
                  <div class="help-block"></div>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="email" class="form-control" id="Title" data-error="請輸入字元" required>
                  <div class="help-block"></div>
                </div>
              </div>
