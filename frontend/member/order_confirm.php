...
$sth=$db->query("SELECT * FROM member WHERE account='".$_SESSION['Account']."'");//抓取儲存的$_SESSION['Account']
                  ...
                  <td data-title="數量"><?php echo $_SESSION['cart'][$i]['quantity']; ?></td>
		            ...
		            <form class="form-horizontal" role="form" action="order_success.php" method="post">
		              ...
		              <div class="form-group">
		                ...
		                <div class="col-sm-10">
		                  <label type="text" class="form-control" id="name" name="name"><?php echo $member['name']; ?></label>
		                </div>
		              </div>
									<div class="form-group">
		                <div class="col-sm-2">
